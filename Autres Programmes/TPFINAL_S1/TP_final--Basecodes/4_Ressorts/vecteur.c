...
Vecteur multScalVect(float s, Vecteur v) // Multiplie les composantes x et y par le scalaire
{ 
...
Vecteur subVect(Vecteur v1, Vecteur v2) // Soustrait les 2 vecteurs et retourne le resultat
{ 
